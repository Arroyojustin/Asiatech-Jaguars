                ...
                <div class="card shadow-container mb-4">
                    <div class="card-body">
                        ...
                        <ul style="list-style-type: none; padding-left: 0;">
                            ...
                            <!-- <li>No registered students yet.</li> -->
                        </ul>
                    </div>
                </div>
                        ...
                        <form id="studAddForm">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="studentID" required disabled>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control" id="phone" pattern="[0-9]{10,15}" required disabled>
                                </div>
                                <div class="col-md-6">
                                    <label for="healthProtocol" class="form-label">Health Protocol</label>
                                    <textarea class="form-control" id="healthProtocol" rows="3" placeholder="Enter any health protocol information" disabled></textarea>
                                </div>
                            </div>
